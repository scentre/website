...
export default function ProductCardLayout2({
  title,
  details,
  image1,
  image2,
  ...
  return (
    <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" className={classname}>
      ...
      <div className="lg:mt-[40px] xl:mt-[66px] flex lg:space-x-5 xl:space-x-6 sm:flex sm:flex-col xs:flex-col md:flex md:flex-col md:max-w-full md:px-5">
        {image1 &&
          <img
            src={image1}
            className="lg:w-[180px] xl:w-[240px] sm:w-full sm:pr-[132px] xs:w-full xs:pr-[92px] md:pr-[70px] d:rounded-lg md:pt-2"
            alt="image"
          />
        }
        {image2 &&
          <img
            src={image2}
            className="lg:w-[180px] xl:w-[240px] xl:rounded-lg sm:w-full sm:rounded-lg sm:pl-[132px] xs:w-full xs:pl-[92px] xs:pt-2 md:pl-[70px] sm:pt-2 md:rounded-lg md:pt-2"
            alt="image"
          />
        }
         {image3 &&
